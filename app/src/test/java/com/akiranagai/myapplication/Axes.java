...
public class Axes extends Rendarable {
    //buffer
...
@Override
    public void render(){
        Object3DProperty obj = objects.get(0);
        GLES.selectProgram(GLES.SP_SimpleObject);
        Matrix.setIdentityM(mMatrix, 0);
        Matrix.rotateM(mMatrix, 0, obj.rotateValue, obj.rotateValues[0], obj.rotateValues[1], obj.rotateValues[2]);
        Matrix.translateM(mMatrix, 0, 2f,0f,2f);
        Matrix.scaleM(mMatrix, 0, 3f,3f,3f);
    ...
    public void draw(float r,float g,float b,float a, float linewidth) {
        //頂点点列
